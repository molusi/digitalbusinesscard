...
const Mywork=()=>{return (
    <div className='row'>
        <div className='website px-0 btn-sm'><a href='.' target='_blank' style={{color:'white',textDecoration:'none',margin:'10px',border:'solid 2px white',borderRadius:'3px',padding:'0.4rem 0.5rem'}}>My work (Loading)</a></div>
